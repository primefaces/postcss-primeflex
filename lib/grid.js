...
const addCols = (widths, element, opts, breakpoint) => {
    ...
    colRule.append({ prop: 'padding', value: opts.gutter, important: _important });
    if (breakpoint)
    ...
    colFixedRule.append({ prop: 'padding', value: opts.gutter, important: _important });
    if (breakpoint)
    ...
    for (let i = 0; i < widths.length; i++) {
        ...
        rule.append({ prop: 'padding', value: opts.gutter, important: _important });
...
module.exports = (root, opts) => {
    ...
    rule.append({ prop: 'margin-left', value: '-' + opts.gutter, important: important });
    rule.append({ prop: 'margin-right', value: '-' + opts.gutter, important: important });
    rule.append({ prop: 'margin-top', value: '-' + opts.gutter, important: important });
    root.before(rule);
